...
import { Camera, Upload, Home, BarChart3, Star, Download, Share2, ArrowLeft, Image as ImageIcon, X ,Info} from 'lucide-react';
import { useToast } from '@/components/ui/use-toast';
import starfieldBg from "@/assets/star-bg9.jpg";

//import starfieldBg from '@/assets/starfield-bg.jpg';
import galaxyBg from '@/assets/galaxy-bg.jpg';

type Screen = 'home' | 'upload' | 'analysis' | 'results' | 'about';
...
export const StarCounter = () => {
  ...
  try {
    ...
    // Fake progress increment while API is being called
  ...
  style={{ backgroundImage: "url('/star-bg10.jpg')" }}>
      ...
      <nav className="relative z-10 p-4 flex justify-between items-center">
        ...
        <div className="flex gap-2 ml-auto">
          ...
          <Button 
            variant="glass"
            size="sm"
            onClick={() => window.location.href = '/star-stories'}
          >
      ...
      {currentScreen === 'home' && (
        <div className="relative z-10 px-6 py-8 text-center">
          <div className="mb-12 float">
            ...
            <p className="text-xl font- italic  text-fade-white">
            {/* bg-gradient-to-r from-rose-500 via-amber-400 to-emerald-400 
            bg-clip-text text-transparent"> 
                   Let's count the stars tonight—bet we lose track before we reach a hundred!
                   <p className="text-white mt-4 text-sm leading-relaxed">
               For the best results, use a clear,well-lit photo of the night sky.
...
<div className="mb-6 bg-black/30 rounded-lg p-4 border border-white/20 glass-card">
  <div>
    <h3 className="text-lg font-semibold text-cosmic-white mb-4 glow-purple">💫 Quick, Friendly Notes</h3>
    <ul className="list-none space-y-3">
      {[
        ...
        <li key={idx} className="flex items-start">
          <span className="flex-shrink-0 text-neon-purple text-lg mr-2 mt-1 glow-purple">•</span>
  ...
  >
    ...
    Proceed
          ...
          <Card className="glass-card p-6 mt-12 max-w-lg mx-auto">
            <div 
              className="h-32 rounded-lg bg-cover bg-center mb-4 relative"
              style={{ backgroundImage: `url(${starfieldBg})` }}
            >
              <div className="absolute inset-0 bg-gradient-nebula rounded-lg"></div>
            </div>
            <p className="text-muted-foreground text-sm">
              Get ready—your star count will be revealed after processing!
            </p> 
          </Card>*/}
        </div>
      )}
      ...
      {currentScreen === 'upload' && (
        <div className="relative z-10 px-6 py-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-cosmic-white mb-2">
              Upload Your Sky Photo
            </h2>
            <p className="text-muted-foreground">
              Choose an image to analyze for stars
            </p>
          </div>
          ...
          <div className="relative z-10">
            ...
            <Card className="glass-card p-8 mb-8 max-w-sm mx-auto">
              <div className="text-center">
                ...
                <div className="text-6xl font-bold text-yellow-400 mb-4 glow-blue">
                  {starCount}
                </div>
                <div className="flex justify-center space-x-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Star 
                      key={i} 
                      className="h-4 w-4 text-neon-purple fill-current" 
                    />
                  ))}
                </div>
                <p className="text-muted-foreground text-sm">
            ...
            {/* Image with highlights (if available) */}
            {imagePreview && (
